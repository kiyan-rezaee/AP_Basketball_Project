...
P.mouse.set_cursor((16, 16), (1, 1), (0, 0, 96, 0, 120, 0, 62, 0, 63, 128, 31, 224, 31, 248, 15, 254, 15, 254, 7, 128, 7, 128, 3, 128, 3, 128, 1, 128, 1, 128, 0, 0),
                   (224, 0, 248, 0, 254, 0, 127, 128, 127, 224, 63, 248, 63, 254, 31, 255, 31, 255, 15, 254, 15, 192, 7, 192, 7, 192, 3, 192, 3, 192, 1, 128))
# menu
Mode = ''
...
Music = [r".Sounds\main_music1.mp3", r".Sounds\main_music2.mp3", r".Sounds\main_music3.mp3"]
goal_sound = [P.mixer.Sound(".Sounds\goal1.wav"), P.mixer.Sound(".Sounds\goal2.wav"), P.mixer.Sound(".Sounds\goal3.wav")]
ball_sound = [P.mixer.Sound(r".Sounds\ball1.wav"), P.mixer.Sound(r".Sounds\ball2.wav")]
...
Sprite_pics_2 = [# sprite in one position
    ".Images\sprite_0r.png",
    ".Images\sprite_1r.png",
    ".Images\sprite_2r.png",
    ".Images\sprite_3r.png",
    ".Images\sprite_4r.png",
    ".Images\sprite_5r.png",
    ".Images\sprite_6r.png"]
Sprite_passive = [  # sprite in passive mode for menu
    ".Images\sprite_chr_0.png",
    ".Images\sprite_chr_1.png",
    ".Images\sprite_chr_2.png",
    ".Images\sprite_chr_3.png",
    ".Images\sprite_chr_4.png",
    ".Images\sprite_chr_5.png",
    ".Images\sprite_chr_6.png"
]
Sprite_active = [  # sprite in active/hover mode for menu
    ".Images\sprite_chr_hover_0.png",
    ".Images\sprite_chr_hover_1.png",
    ".Images\sprite_chr_hover_2.png",
    ".Images\sprite_chr_hover_3.png",
    ".Images\sprite_chr_hover_4.png",
    ".Images\sprite_chr_hover_5.png",
...
try:
    connect = sqlite3.connect('database.db')  # opening db file for storing and reading database
